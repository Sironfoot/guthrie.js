...
exports.executeController = function(executeContext, finishedCallback) {
    ...
    res.end = function() {
        ...
        callNextMiddlewear(resultExecutedCallbacks, controller, req, res, function() {
    ...
    callNextMiddlewear(middlewareCallbacks, controller, req, res, function() {
        ...
        action[verb].call(controller, req, res, function() {
            ...
            callNextMiddlewear(actionExecutedCallbacks, controller, req, res, function() {
